...
<body>
<div align="right"><form action="login.html">
<input type="submit" value="Log out">
</form>
</div>
	<spring:form name="registerlaptopform" method="post">
		<div align="center">
			<table>
				<tr>
					<td>Name</td>
				...
				<tr>
					<td>Graphics</td>
					<td><input name="graphics" type="text"></td>
				</tr>
				<tr>
					<td>RAM</td>
				...
				<tr>
					<td>Storage</td>
					<td><input name="storage" type="text"></td>
				</tr>
				<tr>
					<td>Image</td>
